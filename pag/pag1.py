...
def show_results():
    ...
    # Adicionar um GIF no topo da página
    st.image("https://media.giphy.com/media/3o6ZsVyt7BLs4Te5Vu/giphy.gif", caption="Aqui estão os resultados do seu treinamento!", use_column_width=True)
    ...
    # Adiciona um GIF animado de gatos e cachorros no final da página
    st.image("https://media.giphy.com/media/JIX7iU9o2vOe8/giphy.gif", caption="Gatos e Cachorros em Ação!", use_column_width=True)
